window.onload = () => {
  ...
  // --- ЕЛЕМЕНТИ ЗА КАНТОВЕ ---
  const edgeTopEl = document.getElementById('edgeTop');
  const edgeBottomEl = document.getElementById('edgeBottom');
  const edgeLeftEl = document.getElementById('edgeLeft');
  const edgeRightEl = document.getElementById('edgeRight');
  ...
  document.getElementById('addPart').onclick = () => {
    ...
    const updatedPart = {
      ...
      edgeThickness,
      edge: {
        top: edgeTopEl.classList.contains('active'),
        bottom: edgeBottomEl.classList.contains('active'),
        left: edgeLeftEl.classList.contains('active'),
        right: edgeRightEl.classList.contains('active'),
      },
    };
  ...
  function updatePartsList() {
    ...
    parts.forEach((p, i) => {
      ...
      editBtn.onclick = (e) => {
        ...
        // Зареждане на визуалните кантове чрез правилните референции
        edgeTopEl.classList.toggle('active', p.edge.top);
        edgeBottomEl.classList.toggle('active', p.edge.bottom);
        edgeLeftEl.classList.toggle('active', p.edge.left);
        edgeRightEl.classList.toggle('active', p.edge.right);
